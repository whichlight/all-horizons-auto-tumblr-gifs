(function(exports) {
  ...
  exports.strokeWeight = function(w) {
    if (typeof w === 'undefined' || w === 0) pCurElement.context.lineWidth = 0.0001; // hack because lineWidth 0 doesn't work
  ...
  exports.beginShape = function(kind) {
    if (kind == exports.POINTS || kind == exports.LINES || kind == exports.TRIANGLES || kind == exports.TRIANGLE_FAN || kind == exports.TRIANGLE_STRIP || kind == exports.QUADS || kind == exports.QUAD_STRIP) pShapeKind = kind;
  ...
  */
  ...
  function pSetupInput() {
    document.body.onmousemove = function(e) {
      ...
      if (!pMousePressed && typeof mouseMoved === 'function') mouseMoved(e);
      if (pMousePressed && typeof mouseDragged === 'function') mouseDragged(e);
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (!pMousePressed && typeof s.mouseMoved === 'function') s.mouseMoved(e);
        if (pMousePressed && typeof s.mouseDragged === 'function') s.mouseDragged(e);
      }
    };
    document.body.onmousedown = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (typeof s.mousePressed === 'function') s.mousePressed(e);
      }
    };
    document.body.onmouseup = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (typeof s.mouseReleased === 'function') s.mouseReleased(e);
      }
    };
    document.body.onmouseclick = function(e) {
      if (typeof mouseClicked === 'function') mouseClicked(e);
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (typeof s.mouseClicked === 'function') s.mouseClicked(e);
      }
    };
    document.body.onmousewheel = function(e) {
      if (typeof mouseWheel === 'function') mouseWheel(e);
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (typeof s.mouseWheel === 'function') s.mouseWheel(e);
      }
    };
    document.body.onkeydown = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (typeof s.keyPressed === 'function') s.keyPressed(e);
      }
    };
    document.body.onkeyup = function(e) {
      ...
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (typeof s.keyReleased === 'function') s.keyReleased(e);
      }
    };
    document.body.onkeypress = function(e) {
      if (typeof keyTyped === 'function') keyTyped(e);
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (typeof s.keyTyped === 'function') s.keyTyped(e);
      }
    };
    document.body.ontouchstart = function(e) {
      pSetTouchPoints(e);
      if (typeof touchStarted === 'function') touchStarted(e);
      var m = typeof touchMoved === 'function';
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (typeof s.touchStarted === 'function') s.touchStarted(e);
    ...
    document.body.ontouchmove = function(e) {
      pSetTouchPoints(e);
      if (typeof touchMoved === 'function') touchMoved(e);
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (typeof s.touchMoved === 'function') s.touchMoved(e);
      }
    };
    document.body.ontouchend = function(e) {
      pSetTouchPoints(e);
      if (typeof touchEnded === 'function') touchEnded(e);
      for (var i = 0; i < pSketches.length; i++) {
        var s = pSketches[i];
        if (typeof s.touchEnded === 'function') s.touchEnded(e);
      }
    };
  }
...
//  exports.println = console.log.bind(console);
  ...
  exports.colorMode = function(mode) {
    if (mode == exports.RGB || mode == exports.HSB) pColorMode = mode;
  };
  ...
  */
  ...
  exports.constrain = function(n, l, h) {
  ...
  exports.degrees = function(x) {
    return 360.0 * x / (2 * Math.PI);
  };
  exports.radians = function(x) {
    return 2 * Math.PI * x / 360.0;
  };
  ...
  exports.POINTS = 'points', exports.LINES = 'lines', exports.TRIANGLES = 'triangles', exports.TRIANGLE_FAN = 'triangles_fan', exports.TRIANGLE_STRIP = 'triangles_strip', exports.QUADS = 'quads', exports.QUAD_STRIP = 'quad_strip';
  exports.CLOSE = 'close';
  ...
  var pStartTime;
  var pUpdateInterval;
  var pRectMode = exports.CORNER,
    pImageMode = exports.CORNER;
